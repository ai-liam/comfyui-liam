...
const start = (element, id, startBtn, node) => {
  ...
  window.recognition.onresult = function (event) {
    ...
    data[id] = result.trim()
    localStorage.setItem('_liam_speech_recognition', JSON.stringify(data))
...
app.registerExtension({
  name: 'Liam.audio.SpeechRecognition',
  ...
  async beforeRegisterNodeDef (nodeType, nodeData, app) {
    if (nodeType.comfyClass == 'SpeechRecognitionLiam') {
      ...
      nodeType.prototype.onNodeCreated = function () {
        ...
        let inputAudio = inputDiv('_liam_speech_recognition', 'audio')
  ...
  async loadedGraphNode (node, app) {
    if (node.type === 'SpeechRecognitionLiam') {
      let data = getLocalData('_liam_speech_recognition')
      // console.log('_liam_speech_recognition', node )
...
app.registerExtension({
  ...
  async beforeRegisterNodeDef (nodeType, nodeData, app) {
    if (nodeData.name === 'SpeechSynthesisLiam') {
