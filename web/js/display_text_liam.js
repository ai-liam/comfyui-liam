...
app.registerExtension({
  name: "Liam.DisplayText",
  async beforeRegisterNodeDef(nodeType, nodeData, app) {
    // --- LiamLibDisplayText Node
    if (nodeData.name === "LiamLibDisplayText") {
      // Node Created
      ...
      nodeType.prototype.onNodeCreated = function () {
        ...
        let LiamLibDisplayText = app.graph._nodes.filter(
            (wi) => wi.type == nodeData.name
          ),
          nodeName = `${nodeData.name}_${LiamLibDisplayText.length}`;
